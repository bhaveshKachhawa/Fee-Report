<?php
    ...
    if($rowcount == 0)
    {
        mysqli_query($conn,'ALTER TABLE accountant DROP COLUMN id');
        mysqli_query($conn,'ALTER TABLE accountant ADD COLUMN id INT NOT NULL AUTO_INCREMENT FIRST,ADD PRIMARY KEY (id)');             
