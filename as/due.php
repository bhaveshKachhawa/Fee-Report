<?php
    ...
    $query='select * from student WHERE due!=0 ';
    ...
    if($result->num_rows === 0)
    {
        ...
        ?><script type="text/javascript">alert('No Due.');
        window.location = "../accoutantlogin.php";</script>
        <?php
    }
...
<script type="text/javascript">
  function e(id)
  {
    location.href="edt.php?did="+id;
  }
  function d(id)
  {
    location.href="dlt.php?del="+id;
  }
</script>
<script type = "text/javascript" >
...
<div class="container" id="r1">
    ...
    <thead style="background-color: grey;color: black;opacity: 0.8;">
        <tr>
            <th>Id</th>
            <th>Name</th>
            <th>Email</th>
